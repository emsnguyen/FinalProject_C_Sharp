<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Other.aspx.cs" Inherits="FinalProject.Other" %>
...
<body>
    <form id="form1" runat="server">
                        ...
                        <ul class="megamenu skyblue">
                            ...
                            <li>
                                ...
                                <asp:LinkButton ID="linkLogout"
                                    CssClass="color1"
                                    runat="server" OnClick="linkLogout_Click">Đăng xuất</asp:LinkButton>
                                <%} %>
        ...
        <div class="sp-content">
                    ...
                    <div class="container-sp2">
                        ...
                        <div class="infor-sp1">
                            ...
                            <div class="infor-sp1-r">
                                <% string sPrice = String.Format("{0:N}", item.Price); %>
                                <p><%=sPrice %>đ</p>
            ...
            <div class="paging">
                <%= FinalProject.Utils.HtmlHelper.PagingForOther(CurrentPage, PageGap, TotalPage) %>
            </div>
        </div>
        <div class="footer">
            <div class="container">
                <div class="footer_top">
                    ...
                    <div class="col-md-4 box_3">
                        <h3>Được tạo bởi</h3>
                        <h4><a href="https://www.facebook.com/aminusperson">PhongVH</a></h4>
                        <h4><a href="https://www.facebook.com/nguyengiahuy0986">HuyNG</a></h4>
                        <h4><a href="https://www.facebook.com/seaboyhl">AnhPT</a></h4>
                        <h4><a href="https://www.facebook.com/son.hoanglethanh">SonHLT</a></h4>
                        <h4><a href="https://www.facebook.com/hongmienft98">MienNTH</a></h4>
                    </div>
                    <div class="col-md-4 box_3">
                        <h3>Hỗ trợ</h3>
                        <ul class="list_1">
